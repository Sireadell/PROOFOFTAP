...
export default function TapPage() {
  ...
  // Commented out badge popup effect entirely
  /*
  useEffect(() => {
      ...
      <div className="bg-black bg-opacity-60 backdrop-blur-md rounded-xl p-8 flex flex-col md:flex-row gap-8 shadow-xl">
        ...
        <aside className="w-full md:w-72 bg-gray-900 rounded-lg p-6 flex flex-col gap-6 select-none shadow-md">
          ...
          <div>
            <h2 className="font-semibold text-2xl mb-4">
              Stats {/* Removed BadgeDisplay here */}
            </h2>
            <p className="text-lg">
        ...
        <section className="flex-1 flex flex-col items-center justify-center space-y-8">
          {showClaimButton ? (
            ...
            <button
              ...
              className="relative w-56 h-56 rounded-full bg-gradient-to-br from-purple-700 to-pink-600 shadow-2xl hover:shadow-pink-600 hover:scale-110 transition-transform animate-breathing flex items-center justify-center"
            >
              {/* Gem SVG Icon */}
              <svg
        ...
        <aside className="w-full md:w-72 bg-gray-900 rounded-lg p-6 flex flex-col gap-6 shadow-md max-h-[500px] overflow-y-auto">
          ...
          <div className="mt-auto">
            <SocialShare
              badgeEmoji=""  // You can optionally pass empty string here if you want to hide badge from share
              badgeName=""
